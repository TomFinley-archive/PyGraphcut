...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	void Graph::set_orphan_front(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	void Graph::set_orphan_rear(node *i)
{
	nodeptr *np;
	i -> parent = ORPHAN;
	np = nodeptr_block -> New();
...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	void Graph::add_to_changed_list(node *i)
{
...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	void Graph::maxflow_reuse_trees_init()
{
	node* i;
	node* j;
...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	Graph::flowtype Graph::maxflow(bool reuse_trees, Block<node_id>* _changed_list)
{
...
/*template <typename captype, typename tcaptype, typename flowtype>*/ 
	void Graph::test_consistency(node* current_node)
{
	node *i;
	arc *a;
	int r;
